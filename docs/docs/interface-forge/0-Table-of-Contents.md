...
- [Usage](usage)
  ...
  - [Passing default values](usage#passing-default-values)
    - [Note regarding iteration](usage#note-regarding-iteration)
  ...
  - [Batch building](usage#batch-building)
    - [Note regarding async](usage#note-regarding-async)
...
- [Factory Schema](factory-schema)
  ...
  - [Using Generators](factory-schema#using-generators)
    - [The .iterate method](factory-schema#the-iterate-method)
    - [The .sample method](factory-schema#the-sample-method)
